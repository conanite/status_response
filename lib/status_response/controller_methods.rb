module StatusResponse
  module ControllerMethods
    def back                           ; params[:return_to].present? ? redirect_to(params[:return_to].to_s) : redirect_back(fallback_location: "/") ; end
    ...
    def not_found msg=nil
      status_response_with_html_format do
        render "errors/404_not_found", :status => 404, :layout => layout_for_error_status(404), locals: { :msg => msg }
        false
      end
    end
